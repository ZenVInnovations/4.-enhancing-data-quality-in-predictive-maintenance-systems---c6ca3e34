...
#
# This notebook will perform the data quality process twice with different random seeds to show two different examples of outputs and graphs, and includes sections for testing/quality checking the results.
...
# %% [markdown]
# ## 4. Testing Imputation (Run 1)
#
# Code to check if missing values were successfully imputed.

# %%
print("\nRun 1: Imputation Quality Check:")
# Check if there are any missing values left in the numerical columns
if data_run1[numerical_cols].isnull().sum().sum() == 0:
    print("    ✓ Passed: No missing values found after imputation.")
else:
    print("    ✗ Failed: Missing values still present after imputation.")
    print(data_run1[numerical_cols].isnull().sum())

# Display summary statistics after imputation
print("\nRun 1: Summary statistics after imputation:")
print(data_run1[numerical_cols].describe())

# %% [markdown]
# ## 5. Detect Outliers using Scikit-learn (Run 1)
#
...
# %% [markdown]
# ## 6. Testing Outlier Detection (Run 1)
#
# Code to check the proportion of detected outliers.

# %%
print("\nRun 1: Outlier Detection Quality Check:")
total_rows_run1 = data_run1.shape[0]

# Proportion of outliers detected by Isolation Forest
iso_forest_outliers_count_run1 = data_run1[data_run1['iso_forest_outlier'] == -1].shape[0]
iso_forest_outliers_proportion_run1 = iso_forest_outliers_count_run1 / total_rows_run1
print(f"    Isolation Forest detected {iso_forest_outliers_count_run1} outliers ({iso_forest_outliers_proportion_run1:.2%} of total data).")

# Proportion of outliers detected by LOF
lof_outliers_count_run1 = data_run1[data_run1['lof_outlier'] == -1].shape[0]
lof_outliers_proportion_run1 = lof_outliers_count_run1 / total_rows_run1
print(f"    LOF detected {lof_outliers_count_run1} outliers ({lof_outliers_proportion_run1:.2%} of total data).")

# Note: Visual inspection of plots (in the next section) is also a key part of testing outlier detection.

# %% [markdown]
# ## 7. Visualize Sensor Data and Detected Outliers (Run 1)
#
# Visualizing the data and detected outliers for the first dataset.

# %% [markdown]
# ### 7.1 Time Series Plots (Run 1)
...
# %% [markdown]
# ### 7.2 Scatter Plots with Outliers (Isolation Forest, Run 1)
...
# %% [markdown]
# ### 7.3 Scatter Plots with Outliers (Local Outlier Factor, Run 1)
...
# %% [markdown]
# ## 8. Handling Detected Outliers (Example: Removal, Run 1)
...
# Display summary statistics after removing outliers (Isolation Forest)
print("\nRun 1: Summary statistics after removing Isolation Forest outliers:")
print(data_cleaned_iso_run1[numerical_cols].describe())
...
# %% [markdown]
# ## 4. Testing Imputation (Run 2)
#
# Code to check if missing values were successfully imputed.

# %%
print("\nRun 2: Imputation Quality Check:")
# Check if there are any missing values left in the numerical columns
if data_run2[numerical_cols].isnull().sum().sum() == 0:
    print("    ✓ Passed: No missing values found after imputation.")
else:
    print("    ✗ Failed: Missing values still present after imputation.")
    print(data_run2[numerical_cols].isnull().sum())

# Display summary statistics after imputation
print("\nRun 2: Summary statistics after imputation:")
print(data_run2[numerical_cols].describe())


# %% [markdown]
# ## 5. Detect Outliers using Scikit-learn (Run 2)
#
...
# %% [markdown]
# ## 6. Testing Outlier Detection (Run 2)
#
# Code to check the proportion of detected outliers.

# %%
print("\nRun 2: Outlier Detection Quality Check:")
total_rows_run2 = data_run2.shape[0]

# Proportion of outliers detected by Isolation Forest
iso_forest_outliers_count_run2 = data_run2[data_run2['iso_forest_outlier'] == -1].shape[0]
iso_forest_outliers_proportion_run2 = iso_forest_outliers_count_run2 / total_rows_run2
print(f"    Isolation Forest detected {iso_forest_outliers_count_run2} outliers ({iso_forest_outliers_proportion_run2:.2%} of total data).")

# Proportion of outliers detected by LOF
lof_outliers_count_run2 = data_run2[data_run2['lof_outlier'] == -1].shape[0]
lof_outliers_proportion_run2 = lof_outliers_count_run2 / total_rows_run2
print(f"    LOF detected {lof_outliers_count_run2} outliers ({lof_outliers_proportion_run2:.2%} of total data).")

# Note: Visual inspection of plots (in the next section) is also a key part of testing outlier detection.

# %% [markdown]
# ## 7. Visualize Sensor Data and Detected Outliers (Run 2)
#
# Visualizing the data and detected outliers for the second dataset.

# %% [markdown]
# ### 7.1 Time Series Plots (Run 2)
...
# %% [markdown]
# ### 7.2 Scatter Plots with Outliers (Isolation Forest, Run 2)
...
# %% [markdown]
# ### 7.3 Scatter Plots with Outliers (Local Outlier Factor, Run 2)
...
# %% [markdown]
# ## 8. Handling Detected Outliers (Example: Removal, Run 2)
...
# Display summary statistics after removing outliers (Isolation Forest)
print("\nRun 2: Summary statistics after removing Isolation Forest outliers:")
print(data_cleaned_iso_run2[numerical_cols].describe())
